                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ \Illuminate\Support\Facades\Auth::user()->surname }}"  autocomplete="surname" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" name="nick" value="{{ \Illuminate\Support\Facades\Auth::user()->nick }}"  autocomplete="nick" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="image-path" class="col-md-4 col-form-label text-md-end">{{ __('Avatar') }}</label>
                            ...
                            <div class="row mb-0">
                                <div class="col-md-6 offset-md-4" style="display: flex; gap: 30px; ">
